...
def get___tcfapiLocator():
    global driver
    return driver.find_elements_by_xpath("//iframe[contains(@name, '__tcfapiLocator')]")
...
def extract_CMP_list_from_server():
    ...
    driver.get(iab_url)
    driver.find_element_by_xpath("//*[contains(text(), 'TCF v2.0 CMP Service')]").click()
    ...
    driver.find_element_by_xpath("//*[contains(text(), 'TCF v2.0 CMP Private (own use)')]").click()
