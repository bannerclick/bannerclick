...
# To upgrade:
#    1. Go to: https://hg.mozilla.org/releases/mozilla-beta/tags.
...
TAG='3824638fcd38c9ba50d007a41a1ad453ad7b20bc'
...
UNBRANDED_RELEASE_BUILD="https://firefox-ci-tc.services.mozilla.com/api/index/v1/task/gecko.v2.mozilla-beta.revision.${TAG}.firefox.${OS}64-add-on-devel/artifacts/public/build/target${TARGET_SUFFIX}"
